...
- Windows / Linux: download from [dotnet.microsoft.com/download](https://dotnet.microsoft.com/download)
- Linux (package manager): see [learn.microsoft.com/dotnet/core/install/linux](https://learn.microsoft.com/dotnet/core/install/linux)
